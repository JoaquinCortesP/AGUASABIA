...
export function LayerSelector({ 
  ...
  const categories = [
    ...
    { id: "territorio", label: "🗺️ Límites Territoriales" },
    { id: "riesgos", label: "⚠️ Amenazas y Riesgos" }
  ] as const;

  return (
    <div className="space-y-4">
      {categories.map((cat) => {
        const catLayers = environmentalLayers.filter((l) => l.category === cat.id);
              ...
              {catLayers.map((layer) => {
                ...
                return (
                  ...
                  >
                    ...
                    {isSelected && hasItems && onItemSelect && (
                      <select
                        onChange={(e) => {
